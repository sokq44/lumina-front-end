...
const GoBackArrow: FC<GoBackArrowProps> = ({ to, position }) => {
  ...
  let finalClassName =
    "fixed top-0 z-50 m-2 p-2 rounded-md text-primary bg-gray-200 transition-all duration-300 cursor-pointer hover:bg-secondary dark:bg-gray-800 dark:hover:bg-primary/15";
